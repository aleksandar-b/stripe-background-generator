...
const NavBar = props => {
  const {
    classes,
    store: { headOfPalette, currentBackgroundName },
  } = props;
        ...
        <Toolbar>
          ...
          >
            <div className={classes.wrap}>
              <Chip
                icon={<Icon>device_hub_icon</Icon>}
              ...
              <span className={classes.github}>
                <a href="https://github.com/aleksandar-b/stripe-background-generator" target="_blank" rel="noopener noreferrer">
                  <svg xmlns="http://www.w3.org/2000/svg" width="23.549" height="23.549" viewBox="0 0 438.549 438.549">
